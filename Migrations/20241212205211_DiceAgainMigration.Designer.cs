...
namespace CharacterManager.Migrations
{
    ...
    [Migration("20241212205211_DiceAgainMigration")]
    partial class DiceAgainMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CharacterManager.Models.Class", b =>
                {
                    ...
                    b.HasOne("CharacterManager.Models.Dice", "StartingGoldDice")
                        .WithMany()
                        .HasForeignKey("StartingGoldDiceId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CharacterManager.Models.Dice", b =>
                {
                    b.HasOne("CharacterManager.Models.Class", "BelongToClass")
                        .WithMany()
                        .HasForeignKey("BelongToClassId");
